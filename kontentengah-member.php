          ...
          <div class="col-sm-8 col-sm-offset-2">
            <div class="header-caption marg-40-top text-center">
              ...
              <div class="header-action-button">
                <a class="btn btn-danger btn-md" href="index.php?hal=register">Daftar Sekarang</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <img src="assets/img/img_8585.jpg" class="img-responsive cast-shadow">
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            ...
            <a href="index.php?hal=register" class="button">Daftar Sekarang !</a>
          </div>
        </div><!-- .row -->
      </div><!-- .container -->
    </div><!-- #cta-2 -->
