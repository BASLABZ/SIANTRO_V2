  <?php 
    ...
    if (isset($_POST['jadwal'])) {
      $queryjadwal  = "INSERT INTO tbl_jadwal (jadwal_hari,jadwal_mulai,jadwal_selesai,selectcalss_id_fk,trainee_id_fk,rooms_id_fk,jadwal_jenis) 
        VALUES ('".$_POST['jadwal_hari']."','".$_POST['jadwal_mulai']."','".$_POST['jadwal_selesai']."','".$rowList['selectcalss_id']."','".$rowtrain['trainee_id_fk']."','".$_POST['rooms_id']."','UJIAN')";
    ...
    if (isset($_GET['hapus'])&&isset($_GET['id'])) {
      ...
      if ($queryhapusjadwal) {
          echo "<script> alert('Data Berhasil Disimpan'); location.href='index.php?hal=penjadwalan/add_penjadwalan_ujian&id=".$_GET['id']."' </script>";exit;
        }
    }
  ...
  <section class="content">
    <div class="col-md-6">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Penjadwalan Ujian Kursus</h3>
    ...
    <div class="box box-default">
       <div class="box-header"><h3>JADWAL UJIAN KURSUS</h3></div>
       <div class="box-body">
